...
@endsection
@section('content')
<div class="col-sm-12" id="customer-project-container">
  <div class="card">
    <div class="card-header">
      <h5><a href="{{ url('customer/list') }}">{{ __('Customers') }}</a> >> {{ $customerData->first_name }} {{ $customerData->last_name }} >> {{ __('Projects')  }}</h5>
    ...
    <div class="col-sm-12">
      <form class="form-horizontal" action="{{ url('customer/project/'.$customerData->id) }}" method="GET" id='orderListFilter'>
