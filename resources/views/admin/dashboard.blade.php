...
<div class="col-sm-12">
  <div class="card">
    <div class="p-3 m-0 card-body">
      <form class="form-horizontal" action="{{ url('dashboard') }}" method="GET" accept-charset="UTF-8" id="dashboardForm">
        ...
        @php
          ...
          $to = isset($to)?$to:'';
          $invoiceSummery['overDue'] = null;
          if(isset($invoiceSummery['overDue'])){
            $invoiceSummery['overDue'] = abs($invoiceSummery['overDue']);
          }
        @endphp
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 m-l-10">
          <div class="mt-1 row">
            <div class="pl-0 mb-2 col-md-12 col-xl-4 col-lg-4 col-sm-12 col-xs-12">
              <div class="input-group">           
                <button type="button" class="form-control" id="daterange-btn">
                  <span class="float-left">
                    <i class="fa fa-calendar"></i> {{ __('Date range picker') }}
                  </span>
                  <i class="float-right pt-1 fa fa-caret-down"></i>
                </button> 
              </div>           
            </div>
            <div class="pl-0 mb-2 offset-md-6 col-md-12 col-xl-2 col-lg-2 col-sm-12 col-xs-12" id="currencySelector">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="card theme-bg bitcoin-wallet">
                    <div class="card-block minimize-padding-space">
                      <h5 class="mb-2 text-white">{{ __('Total Amount') }}</h5>
                      <h6 class="mb-2 text-white f-w-200"><strong> {{ formatCurrencyAmount(isset($invoiceSummery['totalInvoice']) ?  $invoiceSummery['totalInvoice'] : 0, $currencySymbol) }}</strong></h6>
                      <i class="float-right text-white fas fa-money-check-alt f-20"></i>                    
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="card theme-bg2 bitcoin-wallet">
                    <div class="card-block minimize-padding-space">
                      <h5 class="mb-2 text-white">{{ __('Total Paid') }}</h5>
                      <h6 class="mb-2 text-white f-w-300"><strong> {{ formatCurrencyAmount(isset($invoiceSummery['totalPaid']) ?  $invoiceSummery['totalPaid'] : 0, $currencySymbol) }}</strong></h6>
                      <i class="float-right text-white fas fa-money-check-alt f-20"></i>                    
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="card theme-bg-y bitcoin-wallet">
                    <div class="card-block minimize-padding-space">
                      <h5 class="mb-2 text-white">{{ __('Total Due') }}</h5>
                      <h6 class="mb-2 text-white f-w-300"><strong>
                ...
                <div class="col-sm-12">
                  <div class="card theme-bg-r bitcoin-wallet">
                    <div class="card-block minimize-padding-space">
                      <h5 class="mb-2 text-white">{{ __('Over Due') }}</h5>
                      <h6 class="mb-2 text-white f-w-300"><strong>
    ...
    <div class="p-0 card-block">
      <div class="card">
        <div class="p-0 card-body">
          ...
          <div class="pt-2 pl-3 tab-content" id="mcap-tabContent">
                ...
                <div class="card-block">
                  <div class="col-sm-12">
                    <div class="row" id="removeBorder">
                      <div class="border col-sm-3 border-top-0 border-bottom-0 border-left-0">
    ...
    <div class="p-0 card-block">
      <div class="px-0 col-sm-12" id="smallDevice"> 
        @if(Helpers::has_permission(Auth::user()->id, 'manage_quotation|own_quotation'))
        <div class="px-0 col-sm-6" id="smallDevicePx">
          <div class="card">
            <div class="card-header">
    ...
    <div class="p-0 card-block" id="ChartJsExpense">
      <div class="mb-0 card">
        <div class="card-header">
