                  ...
                  @if (!empty($companyData['company']['company_logo']))
                    ...
                    ?>  
                      ...
                      <label class="col-sm-3 control-label " for="inputEmail3"></label>
                        <div class="col-sm-7">
                          <div id="logoCompany">
                            <img alt="Company Logo" src='{{url("uploads/companyPic/$image_url")}}' class="img-responsive asa company_logo_padding" id="pro_img" alt="Logo"><span class="remove_img_preview"></span>
                          </div>
                      ...
                      <div class="form-group row pt-1p5rem">
                        ...
                        <div class="col-sm-7">
                          <div id="iconCompany" class="img-wrap-favicon">
                            <img alt="Company Icon" src='{{url("uploads/companyIcon/$image_url")}}' class="img-responsive" id="pro_icon" alt="Icon"><span class="remove_icon_preview"></span>
                          </div>
