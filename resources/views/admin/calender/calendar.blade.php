@extends('layouts.app')
@section('css')
<link rel="stylesheet" href="{{ asset('dist/plugins/fullcalendar/css/main.min.css') }}">
...
@endsection
@section('js')
    <script src="{{ asset('dist/plugins/fullcalendar/js/main.min.js') }}"></script>
    <script src="{{ asset('dist/js/piklor.min.js') }}"></script>
    ...
    <script src="{{ asset('dist/js/custom/calendar.min.js') }}"></script>
@endsection
