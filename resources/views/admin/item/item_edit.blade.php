              ...
              <div class="col-md-4">
                <div class="form-group">
                  <div class="col-md-12 m-l-80 pl-small-0 offset-medium-custom-3">
                      @if (!empty($files[0]->file_name) && file_exists("uploads/items/".$files[0]->file_name))
                        <a class="cursor_pointer" href='{{ url("uploads/items/".$files[0]->file_name) }}'  data-lightbox="image-1" data-title="{{$itemInfo->name}}"><img src='{{ url("uploads/items/".$files[0]->file_name) }}' alt="Item Image" class="img-fluid img-thumbnail img-width-minimize-medium" sizes="(max-width: 200px) 100vw, 200px" id="blah_1"></a>
                      @else
                        <img src='{{ url("dist/img/default_product.jpg") }}' alt="Item Image" class="img-fluid img-thumbnail img-width-minimize-medium" sizes="(max-width: 200px) 100vw, 200px" id="blah_2">
                      @endif
                  </div>
                </div>
