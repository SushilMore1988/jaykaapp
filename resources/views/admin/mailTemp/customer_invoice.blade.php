...
@section('css')
  ...
  <link rel="stylesheet" href="{{ asset('dist/plugins/codemirror/lib/codemirror.css') }}">
@endsection
@section('content')
...
@section('js')
{{-- Classic editor --}}
<script src="{{ asset('dist/plugins/codemirror/lib/codemirror.js') }}"></script>
<script src="{{ asset('dist/plugins/codemirror/mode/xml.js') }}"></script>
