...
@section('content')
  <!-- Main content -->
  <div class="col-sm-12" id="user-purchase-container">
    <div class="card">
      <div class="card-header">
        <h5> <a href="{{ url('users') }}"> {{ __('Users') }} </a>  >> {{ __('Purchase Order') }} >> {{ $user->full_name }}</h5>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 m-l-10">
            <div class="row mt-3 mb-2">
                ...
                <div class="input-group">
                  <button type="button" class="form-control" id="daterange-btn">
                    <span class="float-left">
                      <i class="fa fa-calendar"></i>  {{ __('Date Rane') }}
                    </span>
              ...
              <div class="col-md-3 col-sm-3 col-xs-11 mb-2">
                  <select class="form-control valdation_select select2" name="supplier" id="supplier">
        ...
        <div class="card-block">
          <div class="col-sm-12">
            <div class="table-responsive">
              {!! $dataTable->table(['class' => 'table table-striped table-hover dt-responsive customer-purchases', 'width' => '100%', 'cellspacing' => '0']) !!}
            </div>
          </div>
        </div>
      </div>
