...
@section('css')
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('dist/css/custom-badges.min.css')}}">
...
@section('content')
  ...
  {{-- Loading --}}
  <div id="wait">
    <img src='{{url("dist/img/loader/loader.gif")}}' width="64" height="64" /><br>Loading..
  </div>
...
@section('js')
  ...
  <script src="{{ asset('dist/js/custom/status_priority.min.js') }}"></script>
  <script src="{{ asset('dist/js/custom/canned.min.js') }}"></script>
