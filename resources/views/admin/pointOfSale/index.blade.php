          ...
          <div class="item_section">
            <div id="empty_items_list" class="no-display">
              <div id="empty-content">
                <img src="{{ asset('dist/img/pos-cart.png') }}">
            ...
            <div id="items_list">
              ...
              <div class="single_item">
                ...
                @if(isset($item->image->file_name) && !empty($item->image->file_name) && file_exists(public_path('uploads/items/' . $item->image->file_name)))
                  <img src="{{ url('uploads/items/' . $item->image->file_name) }}" alt="">
                @else
                <img src="{{ url('dist/img/default-image.png') }}"/>
                @endif
...
<script src="{{ asset('dist/js/custom/pos-script.min.js') }}"></script>
@endsection
