...
@section('projectCSS')
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('dist/css/task-list.min.css') }}">
  <link rel="stylesheet" href="{{ asset('dist/css/task-design.min.css?v=1.0') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('dist/css/project.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('dist/plugins/lightbox/css/lightbox.min.css') }}">
@endsection
