    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($request->attachments)) {
                $path = createDirectory("uploads/purchase_order");
    ...
    public function copy($id)
    {
        ...
        try {
            ...
            if ( count($purchaseOrder->purchaseOrderDetails) > 0 ) {
                ...
                $files = (new File)->copyFiles("uploads/purchase_order", "uploads/purchase_order", "Purchase Order", $id, "Purchase Order", $newPurchase->id, ['isUploaded' => true, 'isOriginalNameRequired' => true]);
            }
            DB::commit();
