        ...
        try {
            ...
            if ($res) {
              ...
              if (isset($fileIds) && !empty($fileIds)) {
                  ...
                  (new File)->deleteFiles('USER', $id, ['ids' => [$fileIds], 'isExceptId' => false], $path = 'uploads/user/thumbnail');
              }
              #end region
            }
  ...
  public function teamMemberUpdate(Request $request, $id)
    {
      ...
      try {
        ...
        if (isset($request->attachment) && ! empty($request->attachment)) {
          ...
          if (isset($fileIds) && !empty($fileIds)) {
              (new File)->deleteFiles('USER', $request->id, ['ids' => [$fileIds], 'isExceptId' => false], $path = 'uploads/user');
          }
          #end region
