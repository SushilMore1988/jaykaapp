...
class FilesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($files)) {
            $fileDirectory = createDirectory("uploads/project_files");
    ...
    **/
    ...
    public function downloadAttachment($id)
    {
        $id = base64_decode($id);
        $paths = array(
                    'Invoice Payment' => 'uploads/invoice_payment',
                    'Direct Order' => 'uploads/invoice_order', 
                    'Direct Invoice' => 'uploads/invoice_order',
                    'EXPENSE' => 'uploads/expense',
                    'PROJECT' => 'uploads/project_files',
                    'Ticket Reply' => 'uploads/tickets',
                    'DEPOSIT' => 'uploads/deposit',
                    'Task' => 'uploads/tasks',
                    'Purchase Order' => 'uploads/purchase_order',
                    'Purchase Payment' => 'uploads/purchase_payment',
                    'Item' => 'uploads/items',
                    'USER' => 'uploads/user',
                ); 
