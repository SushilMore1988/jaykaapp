        ...
        return datatables()
            ...
            ->addColumn('img', function ($users) {
                if (isset($users->avatarFile->file_name)  && !empty($users->avatarFile->file_name)) {
                    if (file_exists('uploads/user/thumbnail/' . $users->avatarFile->file_name)) {
                        $img = '<img src="'. url("uploads/user/thumbnail/". $users->avatarFile->file_name) .'" alt="" width="50" height="50">';
                    } else {
                        $img = '<img src="'. url("dist/img/avatar.jpg") .'" alt="" width="50" height="50">';
                    }
                } else {
                        $img = '<img src="'. url("dist/img/avatar.jpg") .'" alt="" width="50" height="50">';
                }
