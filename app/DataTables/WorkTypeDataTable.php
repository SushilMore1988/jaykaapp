...
class WorkTypeDataTable extends DataTable
{
    public function ajax()
    {
        ...
        return datatables()
            ...
            //         if (file_exists('uploads/items/thumbnail/' . $item->file_name)) {
            //             $img = '<img src="'. url("uploads/items/thumbnail/". $item->file_name) .'" alt="" width="50" height="50">';
            //         } else {
            ...
            //     if ($item->is_active == 1) {
            //         $status = '<span class="text-white badge theme-bg f-12">' . __('Active') . '</span>';
            //     } else {
            //         $status = '<span class="text-white badge theme-bg2 f-12">' . __('Inactive') . '</span>';
            //     }
            //     return $status;
            // })
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'name', 'name' => 'items.name', 'title' => __('Name')])

            ->addColumn(['data' => 'category', 'name' => 'items.category', 'title' => __('Category')])
