        ...
        if (data.status == 1) {
          ...
          $.each(data.files, function(key,value) {
            ...
            if (value.object_type =='Task' && jQuery.inArray(ext, image_ext)!='-1') {
              var pic = '/uploads/tasks/'+ value.file_name;
            ...
            var download_path = '/uploads/tasks/'+ value.file_name;
  ...
  success: function(file, response){
    ...
    if (res.result == true) {
      ...
      if (jQuery.inArray(res.data.attachment_extension, ['gif','png','jpg','jpeg']) != -1) {
        var pic = '/uploads/tasks/'+ res.data.attachment_name;
      ...
      var download_path = '/uploads/tasks/'+ res.data.attachment_name;
